...
export const orderDetailsReducer = (state: any = { loading: true, orderItems: [ ], shippingAddress: { } }, action: any) => {
  switch(action.type) {
...
export const orderMyListReducer = (state: any = { orders: [] }, action: any) => {
  switch(action.type) {
